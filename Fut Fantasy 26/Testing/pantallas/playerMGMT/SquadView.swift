...
struct SquadView: View {
    ...
    @State private var hasPickedTeamThisSession: Bool = false
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(showHomeView ? "" : "My Squad")
        ...
        .onChange(of: scenePhase) { oldPhase, newPhase in
            // When app becomes active from background/inactive, show home view
            if newPhase == .active && oldPhase != .active {
                showHomeView = true
                hasPickedTeamThisSession = false
            }
        }
    }
